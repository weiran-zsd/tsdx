...
const fixtureName = 'build-withConfigTs-defineConfig';
const stageName = `stage-integration-${fixtureName}`;

describe('integration :: dts build :: dts-config.ts :: defineConfig', () => {
  beforeAll(() => {
  ...
  it('should create a CSS file in the dist/ directory', () => {
    ...
    expect(
      shell.test(
        '-f',
        'dist/build-withconfigts-defineconfig.cjs.development.css'
      )
    );
  ...
  it('should compile files into a dist directory', () => {
    ...
    expect(
      shell.test(
        '-f',
        'dist/build-withconfigts-defineconfig.cjs.development.js'
      )
    ).toBeTruthy();
    expect(
      shell.test(
        '-f',
        'dist/build-withconfigts-defineconfig.cjs.production.min.js'
      )
    ).toBeTruthy();
    expect(
      shell.test('-f', 'dist/build-withconfigts-defineconfig.esm.js')
    ).toBeTruthy();
